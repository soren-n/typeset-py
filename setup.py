...
DESCRIPTION = 'An embedded DSL for defining source code pretty printers implemented in Python.'
URL = 'https://github.com/soren-n/typeset-python'
OTHER_URL = {
    "Bug Tracker": 'https://github.com/soren-n/typeset-python/issues',
}
...
# Define version
init_path = Path('typeset/__init__.py')
